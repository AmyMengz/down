...
//	public static final int  DO_NOT_GOTO_GOOGLE_STORE=2;
	...
	public static final String IS_AUTO_INJECT_ACCOUNT ="auto_inject_account_flag";
	public static final int  AUTO_INJECT_ACCOUNT=1;
	public static final int  DO_NOT_AUTO_INJECT_ACCOUNT=2;
...
//	}
	...
	public static int getIsAutoInjectAccountFlag(Context context) {
		return System.getInt(context.getContentResolver(),IS_AUTO_INJECT_ACCOUNT, AUTO_INJECT_ACCOUNT);
	}
	public static void setIsAutoInjectAccountFlag(Context context,int value) {
		 System.putInt(context.getContentResolver(), IS_AUTO_INJECT_ACCOUNT, value);
	}
}
