...
public class ChoseMarketPresenter {
	...
	public void init() {
		googleDesAccountFileCheck();
//		googleAccountInjectSet();
		
	}
//	/** 
//	 * 如果自动注入googleAccount
//	 */
//	public void googleAccountInjectSet() {
//		boolean visible=EasyOperateClickUtil.getIsAutoInjectAccountFlag(context)==EasyOperateClickUtil.AUTO_INJECT_ACCOUNT?true:false;
//			choseMarketView.setAutoInjectConfigVisible(visible);
//	}
	/**
	 * Google账户文件是否存在
	 */
	public void googleDesAccountFileCheck(){
