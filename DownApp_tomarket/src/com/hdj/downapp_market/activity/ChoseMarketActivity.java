...
//	@Override
//	public void setAutoInjectConfigVisible(Boolean isVisible) {
//		if(isVisible){
//			tvGoogelAccount.setVisibility(View.VISIBLE);
//			tvGoogelAccountSrc.setVisibility(View.VISIBLE);
//			tvGoogelAccountDes.setVisibility(View.VISIBLE);
//			tvGoogelAccountSrc2.setVisibility(View.GONE);
//		}
//		else {
//			tvGoogelAccount.setVisibility(View.GONE);
//			tvGoogelAccountSrc.setVisibility(View.GONE);
//			tvGoogelAccountDes.setVisibility(View.GONE);
//			tvGoogelAccountSrc2.setVisibility(View.VISIBLE);
//		}
//		
//	}
}
